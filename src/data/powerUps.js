export const POWER_UP_CONFIG = {
  live_feed:        { label: 'Live Feed',        emoji: '📡', desc: '2 minutes of Mister X live location on your map', color: '#e74c3c' },
  direction_beacon: { label: 'Direction Beacon', emoji: '🧭', desc: '2 minutes of direction + distance to the Mister X', color: '#e67e22' },
  ...
  selfie_demand:    { label: 'Selfie Demand',    emoji: '📸', desc: 'Force the Mister X to send you a selfie', color: '#1abc9c' },
};
